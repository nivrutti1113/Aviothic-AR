"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([["extensions_measurement-tracking_src_viewports_TrackedCornerstoneViewport_tsx"], {
"../../../extensions/measurement-tracking/src/viewports/TrackedCornerstoneViewport.tsx"(module, __webpack_exports__, __webpack_require__) {
...
function TrackedCornerstoneViewport(props) {
  ...
  const {
    servicesManager
  } = (0,_ohif_core__rspack_import_7.useSystem)();
  const {
    displaySets,
    viewportId
  } = props;
  ...
  const [trackedMeasurements, sendTrackedMeasurementsEvent] = (0,_getContextModule__rspack_import_5.useTrackedMeasurements)();
...
_s(TrackedCornerstoneViewport, "fj1J4cKvMi3ryZxIpiJTLs/MwXY=", false, function () {
  return [_ohif_core__rspack_import_7.useSystem, _getContextModule__rspack_import_5.useTrackedMeasurements];
});
...
const _getArrowsComponent = (isTracked, switchMeasurement, isActiveViewport) => {
  ...
  return /*#__PURE__*/react__rspack_import_0_default().createElement(_ohif_ui_next__rspack_import_2.ViewportActionArrows, {
