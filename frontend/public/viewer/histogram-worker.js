...
"../../../extensions/cornerstone/src/components/ViewportWindowLevel/histogramWorker.js"(module, __webpack_exports__, __webpack_require__) {
...
const obj = {
  getRange: ({
    ...
    const imageData = _kitware_vtk_js_Common_DataModel_ImageData__rspack_import_1["default"].newInstance();
    imageData.setDimensions(dimensions);
    imageData.setOrigin(origin);
    imageData.setDirection(direction);
    imageData.setSpacing(spacing);
    const scalarArray = _kitware_vtk_js_Common_Core_DataArray__rspack_import_2["default"].newInstance({
      name: 'Pixels',
...
__webpack_require__.hmrF = function () {
            return "5e17803cbbfdddf3." + __webpack_require__.h() + ".hot-update.json";
         };
...
(() => {
var installedChunks = __webpack_require__.hmrS_importScripts = __webpack_require__.hmrS_importScripts || {"histogram-worker": 1,};
