"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([["extensions_dicom-microscopy_src_index_tsx"], {
"../../../extensions/dicom-microscopy/src/DicomMicroscopyANNSopClassHandler.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (getDicomMicroscopyANNSopClassHandler)
});
...
const {
  utils
} = _ohif_core__rspack_import_0["default"];
...
function _getDisplaySetsFromSeries(instances, servicesManager, extensionManager) {
  ...
  const naturalizedDataset = _ohif_core__rspack_import_0.DicomMetadataStore.getSeries(instance.StudyInstanceUID, instance.SeriesInstanceUID).instances[0];
  const {
    SeriesDescription,
    ContentDate,
    ContentTime,
  ...
  displaySet.load = function () {
    return (0,_utils_loadAnnotation__rspack_import_1["default"])({
      microscopyService,
      displaySet,
      extensionManager,
      servicesManager
  ...
  displaySet.getSourceDisplaySet = function () {
    let allDisplaySets = [];
    const studyMetadata = _ohif_core__rspack_import_0.DicomMetadataStore.getStudy(StudyInstanceUID);
    ...
    const ds = (0,_utils_getSourceDisplaySet__rspack_import_2["default"])(allDisplaySets, displaySet);
    return ds;
  };
  return [displaySet];
}
...
"../../../extensions/dicom-microscopy/src/DicomMicroscopySRSopClassHandler.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (getDicomMicroscopySRSopClassHandler)
});
/* import */ var _ohif_core__rspack_import_0 = __webpack_require__("../../core/src/index.ts");
/* import */ var _utils_loadSR__rspack_import_1 = __webpack_require__("../../../extensions/dicom-microscopy/src/utils/loadSR.ts");
...
function _getReferencedFrameOfReferenceUID(naturalizedDataset) {
  ...
  const imagingMeasurementsContentItem = ContentSequence.find(ci => ci.ConceptNameCodeSequence.CodeValue === _utils_dcmCodeValues__rspack_import_3["default"].IMAGING_MEASUREMENTS);
  const firstMeasurementGroupContentItem = (0,_utils_toArray__rspack_import_2["default"])(imagingMeasurementsContentItem.ContentSequence).find(ci => ci.ConceptNameCodeSequence.CodeValue === _utils_dcmCodeValues__rspack_import_3["default"].MEASUREMENT_GROUP);
  const imageRegionContentItem = (0,_utils_toArray__rspack_import_2["default"])(firstMeasurementGroupContentItem.ContentSequence).find(ci => ci.ConceptNameCodeSequence.CodeValue === _utils_dcmCodeValues__rspack_import_3["default"].IMAGE_REGION);
...
function _getDisplaySetsFromSeries(instances, servicesManager, extensionManager) {
  ...
  displaySet.load = function (referencedDisplaySet) {
    return (0,_utils_loadSR__rspack_import_1["default"])(microscopyService, displaySet, referencedDisplaySet).catch(error => {
      displaySet.isLoaded = false;
      displaySet.loadError = true;
      throw new Error(error);
    });
  ...
  displaySet.getSourceDisplaySet = function () {
    ...
    return (0,_utils_getSourceDisplaySet__rspack_import_4["default"])(allDisplaySets, displaySet);
  };
  return [displaySet];
}
...
"../../../extensions/dicom-microscopy/src/components/MicroscopyPanel/MicroscopyPanel.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
const {
  datasetToBuffer
} = dcmjs__rspack_import_6["default"].data;
...
function MicroscopyPanel(props) {
  ...
  const [studyInstanceUID, setStudyInstanceUID] = (0,react__rspack_import_0.useState)(null);
  const [roiAnnotations, setRoiAnnotations] = (0,react__rspack_import_0.useState)([]);
  const [selectedAnnotation, setSelectedAnnotation] = (0,react__rspack_import_0.useState)(null);
  const {
    servicesManager,
    extensionManager
  } = props;
  ...
  (0,react__rspack_import_0.useEffect)(() => {
    ...
    } = microscopyService.subscribe(_services_MicroscopyService__rspack_import_5.EVENTS.ANNOTATION_UPDATED, onAnnotationUpdated);
    const {
      unsubscribe: unsubscribeAnnotationSelected
    } = microscopyService.subscribe(_services_MicroscopyService__rspack_import_5.EVENTS.ANNOTATION_SELECTED, onAnnotationSelected);
    const {
      unsubscribe: unsubscribeAnnotationRemoved
    } = microscopyService.subscribe(_services_MicroscopyService__rspack_import_5.EVENTS.ANNOTATION_REMOVED, onAnnotationRemoved);
    onAnnotationUpdated();
  ...
  const promptSave = () => {
    ...
    (0,_ohif_extension_default__rspack_import_1.callInputDialog)({
      uiDialogService,
  ...
  const saveFunction = async SeriesDescription => {
    ...
    const studyMetadata = _ohif_core__rspack_import_2.DicomMetadataStore.getStudy(studyInstanceUID);
    ...
    const dataset = (0,_utils_constructSR__rspack_import_7["default"])(metadata, {
      SeriesDescription,
      SeriesNumber
    }, annotations);
  ...
  const onDeleteCurrentSRHandler = async () => {
    try {
      ...
      // TODO: studies?
      const study = _ohif_core__rspack_import_2.DicomMetadataStore.getStudy(StudyInstanceUID);
  ...
  }, data.map(item => /*#__PURE__*/react__rspack_import_0_default().createElement(_ohif_ui_next__rspack_import_3.DataRow, {
    key: item.uid,
    number: item.index + 1,
    title: item.label,
...
_c = MicroscopyPanel;
const connectedMicroscopyPanel = (0,react_i18next__rspack_import_4.withTranslation)(['MicroscopyTable', 'Common'])(MicroscopyPanel);
...
"../../../extensions/dicom-microscopy/src/getCommandsModule.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (getCommandsModule)
});
...
function getCommandsModule({
  ...
  const actions = {
    ...
    setLabel: async ({
      ...
      const value = await (0,_ohif_extension_default__rspack_import_0.callInputDialog)({
        uiDialogService,
        title: _ohif_i18n__rspack_import_2["default"].t('Tools:Edit Measurement Label'),
        placeholder: roiAnnotation.label || _ohif_i18n__rspack_import_2["default"].t('Tools:Enter new label'),
    ...
    setToolActive: ({
      ...
      if (['line', 'box', 'circle', 'point', 'polygon', 'freehandpolygon', 'freehandline'].indexOf(toolName) >= 0) {
        ...
        const options = {
          ...
          vertexEnabled: true,
          styleOptions: _utils_styles__rspack_import_1["default"]["default"],
          bindings: {
            mouseButtons: ['left']
          }
        };
...
"../../../extensions/dicom-microscopy/src/getCustomizationModule.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
"../../../extensions/dicom-microscopy/src/getPanelModule.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function getPanelModule({
  ...
  const wrappedMeasurementPanel = ({}) => {
    ...
    return /*#__PURE__*/react__rspack_import_0_default().createElement(_components_MicroscopyPanel_MicroscopyPanel__rspack_import_2["default"], {
      viewports: viewports,
  ...
  _s(wrappedMeasurementPanel, "EV8IprZhHE92zX5UCb7fBNmhByk=", false, function () {
    return [_ohif_ui_next__rspack_import_1.useViewportGrid];
  });
  return [{
    name: 'measure',
    iconName: 'tab-linear',
...
"../../../extensions/dicom-microscopy/src/id.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  id: () => (id)
});
...
"../../../extensions/dicom-microscopy/src/index.tsx"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (__rspack_default_export)
});
/* import */ var _id__rspack_import_0 = __webpack_require__("../../../extensions/dicom-microscopy/src/id.js");
/* import */ var react__rspack_import_1 = __webpack_require__("../../../node_modules/react/index.js");
/* import */ var react__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(react__rspack_import_1);
/* import */ var _getPanelModule__rspack_import_2 = __webpack_require__("../../../extensions/dicom-microscopy/src/getPanelModule.tsx");
/* import */ var _getCommandsModule__rspack_import_3 = __webpack_require__("../../../extensions/dicom-microscopy/src/getCommandsModule.ts");
/* import */ var _getCustomizationModule__rspack_import_4 = __webpack_require__("../../../extensions/dicom-microscopy/src/getCustomizationModule.ts");
/* import */ var _ohif_ui_next__rspack_import_5 = __webpack_require__("../../ui-next/src/index.ts");
/* import */ var _DicomMicroscopySRSopClassHandler__rspack_import_6 = __webpack_require__("../../../extensions/dicom-microscopy/src/DicomMicroscopySRSopClassHandler.js");
/* import */ var _DicomMicroscopyANNSopClassHandler__rspack_import_7 = __webpack_require__("../../../extensions/dicom-microscopy/src/DicomMicroscopyANNSopClassHandler.js");
/* import */ var _services_MicroscopyService__rspack_import_8 = __webpack_require__("../../../extensions/dicom-microscopy/src/services/MicroscopyService.ts");
...
const Component = /*#__PURE__*/react__rspack_import_1_default().lazy(_c = () => {
  return __webpack_require__.e(/* import() */ "extensions_dicom-microscopy_src_DicomMicroscopyViewport_tsx").then(__webpack_require__.bind(__webpack_require__, "../../../extensions/dicom-microscopy/src/DicomMicroscopyViewport.tsx"));
});
_c2 = Component;
const MicroscopyViewport = props => {
  return /*#__PURE__*/react__rspack_import_1_default().createElement(react__rspack_import_1.Suspense, {
...
const extension = {
  ...
  async preRegistration({
    ...
    servicesManager.registerService(_services_MicroscopyService__rspack_import_8["default"].REGISTRATION(servicesManager));
  },
  /**
  ...
  getViewportModule({
    ...
    const ExtendedMicroscopyViewport = props => {
      ...
      const displaySetsKey = (0,react__rspack_import_1.useMemo)(() => {
        return props.displaySets.map(ds => ds.displaySetInstanceUID).join('-');
      }, [props.displaySets]);
      const onResize = lodash_debounce__rspack_import_10_default()(() => {
        const {
          microscopyService
        } = servicesManager.services;
      ...
      const {
        ref: resizeRef
      } = (0,react_resize_detector__rspack_import_9.useResizeDetector)({
        onResize,
        handleHeight: true,
        handleWidth: true
      });
      const setViewportActive = (0,react__rspack_import_1.useCallback)(viewportId => {
        viewportGridService.setActiveViewportId(viewportId);
      }, [viewportGridService]);
      return /*#__PURE__*/react__rspack_import_1_default().createElement(MicroscopyViewport, _extends({
        key: displaySetsKey,
        activeViewportId: activeViewportId,
    ...
    _s(ExtendedMicroscopyViewport, "emg5kLeU4pdPQL/yK3xqGtktWSU=", false, function () {
      return [_ohif_ui_next__rspack_import_5.useViewportGrid, react_resize_detector__rspack_import_9.useResizeDetector];
    });
    return [{
  ...
  getSopClassHandlerModule(params) {
    return [(0,_DicomMicroscopySRSopClassHandler__rspack_import_6["default"])(params), (0,_DicomMicroscopyANNSopClassHandler__rspack_import_7["default"])(params)];
  },
  getPanelModule: _getPanelModule__rspack_import_2["default"],
  getCommandsModule: _getCommandsModule__rspack_import_3["default"],
  getCustomizationModule: _getCustomizationModule__rspack_import_4["default"]
};
...
"../../../extensions/dicom-microscopy/src/services/MicroscopyService.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  EVENTS: () => (EVENTS),
  "default": () => (MicroscopyService)
});
/* import */ var _tools_viewerManager__rspack_import_0 = __webpack_require__("../../../extensions/dicom-microscopy/src/tools/viewerManager.js");
 ...
 */
class MicroscopyService extends _ohif_core__rspack_import_3.PubSubService {
  constructor({
    servicesManager,
    extensionManager
  }) {
  ...
  _onRoiAdded(data) {
    ...
    const roiAnnotation = new _utils_RoiAnnotation__rspack_import_1["default"](roiGraphic, studyInstanceUID, seriesInstanceUID, '', viewState);
    this.roiUids.add(roiGraphic.uid);
    this.annotations[roiGraphic.uid] = roiAnnotation;
    roiAnnotation.subscribe(_utils_RoiAnnotation__rspack_import_1.EVENTS.LABEL_UPDATED, () => {
  ...
  _addManagedViewerSubscriptions(managedViewer) {
    managedViewer._roiAddedSubscription = managedViewer.subscribe(_tools_viewerManager__rspack_import_0.EVENTS.ADDED, this._onRoiAdded);
    managedViewer._roiModifiedSubscription = managedViewer.subscribe(_tools_viewerManager__rspack_import_0.EVENTS.MODIFIED, this._onRoiModified);
    managedViewer._roiRemovedSubscription = managedViewer.subscribe(_tools_viewerManager__rspack_import_0.EVENTS.REMOVED, this._onRoiRemoved);
    managedViewer._roiUpdatedSubscription = managedViewer.subscribe(_tools_viewerManager__rspack_import_0.EVENTS.UPDATED, this._onRoiUpdated);
    managedViewer._roiSelectedSubscription = managedViewer.subscribe(_tools_viewerManager__rspack_import_0.EVENTS.UPDATED, this._onRoiSelected);
  }
  ...
  addViewer(viewer, viewportId, container, studyInstanceUID, seriesInstanceUID) {
    ...
    const managedViewer = new _tools_viewerManager__rspack_import_0["default"](viewer, viewportId, container, studyInstanceUID, seriesInstanceUID);
  ...
  _potentiallyLoadSR(StudyInstanceUID, displaySets) {
    const studyMetadata = _ohif_core__rspack_import_3.DicomMetadataStore.getStudy(StudyInstanceUID);
    const smDisplaySet = displaySets.find(ds => ds.Modality === 'SM');
    const {
      FrameOfReferenceUID,
  ...
  selectAnnotation(roiAnnotation) {
    ...
    this.setROIStyle(roiAnnotation.uid, _utils_styles__rspack_import_2["default"].active);
  }
...
"../../../extensions/dicom-microscopy/src/tools/viewerManager.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  EVENTS: () => (EVENTS),
  "default": () => (__rspack_default_export)
 ...
 */
class ViewerManager extends _ohif_core__rspack_import_2.PubSubService {
  ...
  addRoiGraphic(roiGraphic) {
    this.runSilently(() => this.viewer.addROI(roiGraphic, _utils_styles__rspack_import_1["default"]["default"]));
  }
  ...
  _jumpToPoint(coord) {
    ...
    const mappedCoord = (0,_utils_coordinateFormatScoord3d2Geometry__rspack_import_0["default"])(coord, pyramid);
    const view = this._getMapView();
  ...
  _jumpToPolygonOrEllipse(coordinates) {
    ...
    coordinates.forEach(coord => {
      let mappedCoord = (0,_utils_coordinateFormatScoord3d2Geometry__rspack_import_0["default"])(coord, pyramid);
...
"../../../extensions/dicom-microscopy/src/utils/DEVICE_OBSERVER_UID.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (__rspack_default_export)
});
...
"../../../extensions/dicom-microscopy/src/utils/RoiAnnotation.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  EVENTS: () => (EVENTS),
  "default": () => (__rspack_default_export)
 ...
 */
class RoiAnnotation extends _ohif_core__rspack_import_1.PubSubService {
  ...
  setMeasurements() {
    ...
    switch (type) {
      case 'ELLIPSE':
        ...
        break;
      case 'POLYGON':
        const areaPolygon = (0,_areaOfPolygon__rspack_import_0["default"])(coordinates);
   ...
   */
  getDetailedLabel() {
    const translatedEmpty = _ohif_i18n__rspack_import_2["default"]?.t('MeasurementTable:empty') || '(empty)';
...
"../../../extensions/dicom-microscopy/src/utils/areaOfPolygon.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
"../../../extensions/dicom-microscopy/src/utils/constructSR.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (constructSR)
});
...
function constructSR(metadata, {
  ...
  const observationContext = new dcmjs__rspack_import_0["default"].sr.templates.ObservationContext({
    observerPersonContext: new dcmjs__rspack_import_0["default"].sr.templates.ObserverContext({
      observerType: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
        value: '121006',
        schemeDesignator: 'DCM',
        meaning: 'Person'
      }),
      observerIdentifyingAttributes: new dcmjs__rspack_import_0["default"].sr.templates.PersonObserverIdentifyingAttributes({
        name: '@ohif/extension-dicom-microscopy'
      })
    }),
    observerDeviceContext: new dcmjs__rspack_import_0["default"].sr.templates.ObserverContext({
      observerType: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
        value: '121007',
        schemeDesignator: 'DCM',
        meaning: 'Device'
      }),
      observerIdentifyingAttributes: new dcmjs__rspack_import_0["default"].sr.templates.DeviceObserverIdentifyingAttributes({
        uid: _DEVICE_OBSERVER_UID__rspack_import_1["default"]
      })
    }),
    subjectContext: new dcmjs__rspack_import_0["default"].sr.templates.SubjectContext({
      subjectClass: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
        value: '121027',
        schemeDesignator: 'DCM',
        meaning: 'Specimen'
      }),
      subjectClassSpecificContext: new dcmjs__rspack_import_0["default"].sr.templates.SubjectContextSpecimen({
  ...
  for (let i = 0; i < annotations.length; i++) {
    ...
    measurements = measurements.map(measurement => {
      ...
      return new dcmjs__rspack_import_0["default"].sr.valueTypes.NumContentItem({
        name: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
        ...
        unit: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
    ...
    evaluations = evaluations.map(evaluation => {
      ...
      return new dcmjs__rspack_import_0["default"].sr.valueTypes.TextContentItem({
        name: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
          value: ConceptName.CodeValue,
          meaning: ConceptName.CodeMeaning,
          schemeDesignator: ConceptName.CodingSchemeDesignator
    ...
    const group = new dcmjs__rspack_import_0["default"].sr.templates.PlanarROIMeasurementsAndQualitativeEvaluations({
      trackingIdentifier: new dcmjs__rspack_import_0["default"].sr.templates.TrackingIdentifier({
        uid: roi.uid,
        identifier: presentationState ? identifier.concat(`(${JSON.stringify(presentationState)})`) : identifier
      }),
      referencedRegion: new dcmjs__rspack_import_0["default"].sr.contentItems.ImageRegion3D({
        graphicType: roi.scoord3d.graphicType,
        graphicData: roi.scoord3d.graphicData,
        frameOfReferenceUID: roi.scoord3d.frameOfReferenceUID
      }),
      findingType: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
        value: label,
  ...
  const measurementReport = new dcmjs__rspack_import_0["default"].sr.templates.MeasurementReport({
    languageOfContentItemAndDescendants: new dcmjs__rspack_import_0["default"].sr.templates.LanguageOfContentItemAndDescendants({}),
    observationContext,
    procedureReported: new dcmjs__rspack_import_0["default"].sr.coding.CodedConcept({
      value: '112703',
      schemeDesignator: 'DCM',
  ...
  const dataset = new dcmjs__rspack_import_0["default"].sr.documents.Comprehensive3DSR({
    content: measurementReport[0],
    evidence: [metadata],
    seriesInstanceUID: dcmjs__rspack_import_0["default"].data.DicomMetaDictionary.uid(),
    seriesNumber: SeriesNumber,
    seriesDescription: SeriesDescription || 'Whole slide imaging structured report',
    sopInstanceUID: dcmjs__rspack_import_0["default"].data.DicomMetaDictionary.uid(),
    instanceNumber: 1,
  ...
  dataset._meta = {
    ...
    ImplementationClassUID: {
      Value: [dcmjs__rspack_import_0["default"].data.DicomMetaDictionary.uid()],
      vr: 'UI'
    },
...
"../../../extensions/dicom-microscopy/src/utils/coordinateFormatScoord3d2Geometry.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function mapSlideCoord2PixelCoord(options) {
  ...
  const mInverted = (0,mathjs__rspack_import_0.inv)(m);
  const vSlide = [[point[0]], [point[1]], [1]];
  const vImage = (0,mathjs__rspack_import_0.multiply)(mInverted, vSlide);
...
"../../../extensions/dicom-microscopy/src/utils/dcmCodeValues.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (__rspack_default_export)
});
...
"../../../extensions/dicom-microscopy/src/utils/dicomWebClient.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (getDicomWebClient)
});
/* import */ var _ohif_core__rspack_import_0 = __webpack_require__("../../core/src/index.ts");
/* import */ var _ohif_extension_default__rspack_import_1 = __webpack_require__("../../../extensions/default/src/index.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = 
...
function getDicomWebClient({
  ...
  const wadoConfig = {
    ...
    errorInterceptor: _ohif_core__rspack_import_0.errorHandler.getHTTPErrorHandler()
  };
  const client = new _ohif_extension_default__rspack_import_1.StaticWadoClient(wadoConfig);
...
"../../../extensions/dicom-microscopy/src/utils/getSourceDisplaySet.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
"../../../extensions/dicom-microscopy/src/utils/loadAnnotation.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function loadAnnotation({
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const client = (0,_dicomWebClient__rspack_import_0["default"])({
        extensionManager,
        servicesManager
      });
...
"../../../extensions/dicom-microscopy/src/utils/loadSR.ts"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (loadSR)
});
...
const MeasurementReport = dcmjs__rspack_import_0["default"].adapters.DICOMMicroscopyViewer.MeasurementReport;
...
async function _getROIsFromToolState(microscopyService, naturalizedDataset, FrameOfReferenceUID) {
  ...
  tools.forEach(t => {
    ...
    const measurementGroupContentItemsForTool = measurementGroupContentItems.filter(mg => {
      const imageRegionContentItem = (0,_toArray__rspack_import_2["default"])(mg.ContentSequence).find(ci => ci.ConceptNameCodeSequence.CodeValue === _dcmCodeValues__rspack_import_1["default"].IMAGE_REGION);
    ...
    toolSpecificToolState.forEach((coordinates, index) => {
      ...
      const findingGroup = (0,_toArray__rspack_import_2["default"])(measurementGroup.ContentSequence).find(ci => ci.ConceptNameCodeSequence.CodeValue === _dcmCodeValues__rspack_import_1["default"].FINDING);
      const trackingGroup = (0,_toArray__rspack_import_2["default"])(measurementGroup.ContentSequence).find(ci => ci.ConceptNameCodeSequence.CodeValue === _dcmCodeValues__rspack_import_1["default"].TRACKING_UNIQUE_IDENTIFIER);
      ...
      let measurements = (0,_toArray__rspack_import_2["default"])(measurementGroup.ContentSequence).filter(ci => [_dcmCodeValues__rspack_import_1["default"].LENGTH, _dcmCodeValues__rspack_import_1["default"].AREA, _dcmCodeValues__rspack_import_1["default"].SHORT_AXIS, _dcmCodeValues__rspack_import_1["default"].LONG_AXIS, _dcmCodeValues__rspack_import_1["default"].ELLIPSE_AREA].includes(ci.ConceptNameCodeSequence.CodeValue));
      let evaluations = (0,_toArray__rspack_import_2["default"])(measurementGroup.ContentSequence).filter(ci => [_dcmCodeValues__rspack_import_1["default"].TRACKING_UNIQUE_IDENTIFIER].includes(ci.ConceptNameCodeSequence.CodeValue));
      ...
      evaluations = evaluations.map(evaluation => {
        ...
        e.ConceptNameCodeSequence = (0,_toArray__rspack_import_2["default"])(e.ConceptNameCodeSequence);
        return e;
      });
      ...
      measurements = measurements.map(measurement => {
        ...
        m.ConceptNameCodeSequence = (0,_toArray__rspack_import_2["default"])(m.ConceptNameCodeSequence);
        return m;
      });
...
function _getMeasurementGroups(naturalizedDataset) {
  ...
  const imagingMeasurementsContentItem = ContentSequence.find(ci => ci.ConceptNameCodeSequence.CodeValue === _dcmCodeValues__rspack_import_1["default"].IMAGING_MEASUREMENTS);
...
"../../../extensions/dicom-microscopy/src/utils/styles.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (__rspack_default_export)
});
...
"../../../extensions/dicom-microscopy/src/utils/toArray.js"(module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": () => (toArray)
});
...
"../../../extensions/dicom-microscopy/package.json"(module) {
module.exports = JSON.parse('{"name":"@ohif/extension-dicom-microscopy","version":"3.14.0-beta.7","description":"OHIF extension for DICOM microscopy","author":"Bill Wallace, md-prog","license":"MIT","repository":"OHIF/Viewers","main":"dist/ohif-extension-dicom-microscopy.umd.js","module":"src/index.tsx","engines":{"node":">=24"},"files":["dist/**","public/**","README.md"],"scripts":{"clean":"shx rm -rf dist","clean:deep":"pnpm run clean && shx rm -rf node_modules","dev":"cross-env NODE_ENV=development rspack build --config .webpack/webpack.dev.js --watch","dev:dicom-pdf":"pnpm run dev","build":"cross-env NODE_ENV=production rspack build --config .webpack/webpack.prod.js","build:package-1":"pnpm run build","start":"pnpm run dev"},"peerDependencies":{"@ohif/core":"workspace:*","@ohif/extension-default":"workspace:*","@ohif/i18n":"workspace:*","@ohif/ui":"workspace:*","prop-types":"15.8.1","react":"18.3.1","react-dom":"18.3.1","react-i18next":"12.3.1","react-router":"6.30.3","react-router-dom":"6.30.3"},"dependencies":{"@babel/runtime":"7.29.7","@cornerstonejs/codec-charls":"1.2.3","@cornerstonejs/codec-libjpeg-turbo-8bit":"1.2.2","@cornerstonejs/codec-openjpeg":"1.3.0","colormap":"2.3.2","dicom-microscopy-viewer":"0.48.6","lodash.debounce":"4.0.8","mathjs":"12.4.3"},"devDependencies":{"cross-env":"7.0.3"},"keywords":["ohif-extension"]}')
